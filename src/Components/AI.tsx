...
const Ai = () => {
  ...
  return (
    ...
    >
      ...
      <div className="ai-answer box-border flex h-full w-full select-text overflow-auto rounded-box bg-secondary-content bg-opacity-85 p-5 pb-32 font-semibold text-secondary xl:pb-10">
